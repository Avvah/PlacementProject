...
var ProfileComponent = (function () {
    function ProfileComponent(_fb, driveservice, route, router, tosterservice) {
        this._fb = _fb;
    ...
    ProfileComponent.prototype.addstudentProfile = function (std) {
        ...
        this.driveservice.addstudentProfile(std)
            ...
            _this.toasterService.pop('success', 'Updated', 'Your Profile was updated Sucessfully');
        }, function (err) {
    ...
    ProfileComponent = __decorate([
        ...
        __metadata('design:paramtypes', [forms_1.FormBuilder, drive_service_1.DriveService, router_1.ActivatedRoute, router_1.Router, angular2_toaster_1.ToasterService])
    ], ProfileComponent);
