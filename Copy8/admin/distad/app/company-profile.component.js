...
var CompanyProfileComponent = (function () {
    function CompanyProfileComponent(driveService, tosterservice, router, route, auth) {
    ...
    CompanyProfileComponent = __decorate([
        ...
        __metadata('design:paramtypes', [drive_service_1.DriveService, angular2_toaster_1.ToasterService, router_1.ActivatedRoute, router_1.Router, authentication_service_1.AuthenticationService])
