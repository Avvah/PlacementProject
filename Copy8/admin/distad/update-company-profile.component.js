...
var UpdateCompanyProfileComponent = (function () {
    function UpdateCompanyProfileComponent(driveService, tosterservice, router, route, authHttp) {
    ...
    UpdateCompanyProfileComponent = __decorate([
        ...
        __metadata('design:paramtypes', [drive_service_1.DriveService, angular2_toaster_1.ToasterService, router_1.ActivatedRoute, router_1.Router, angular2_jwt_1.AuthHttp])
